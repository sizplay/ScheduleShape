    ...
    <body>
        ...
        <div id="main">
            <div align="right" style="margin:15px">
                <button type="button" class="btn btn-sch btn-nosch" data-toggle="modal" data-target="#addSchool">Delete School</button>
                &nbsp;&nbsp;&nbsp;&nbsp;</div>        
                                ...
                                <tbody>
                                    <c:forEach var="i" items="${s}">
                                        <tr>      
                                            ...
                                            <td><div align="center"><a href="../DeleteSchool?SchoolID=${i.getSchoolID()}">
